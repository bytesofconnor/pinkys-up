export function BlushHourGlass() {
  return (
    <svg viewBox="0 0 300 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-full w-full" aria-hidden="true">
      ...
      <path d="M90 100 L210 100 L210 350 L90 350 Z" fill="url(#blushHourGrad)" opacity="0.92" />
      ...
      <circle cx="135" cy="220" r="2.5" fill="white" opacity="0.5">
        <animate attributeName="cy" from="310" to="160" dur="2.8s" repeatCount="indefinite" />
      </circle>
      ...
      <defs>
        <linearGradient id="blushHourGrad" x1="150" y1="100" x2="150" y2="350" gradientUnits="userSpaceOnUse">
...
export function PlusOneGlass() {
  return (
    <svg viewBox="0 0 300 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-full w-full" aria-hidden="true">
      ...
      <path d="M150 105 C150 105,205 142,205 198 C205 235,187 282,160 292 L150 298 C150 298,115 282,95 198 C95 142,150 105,150 105" fill="url(#plusOneGrad)" opacity="0.95" />
      ...
      <defs>
        <linearGradient id="plusOneGrad" x1="150" y1="105" x2="150" y2="298" gradientUnits="userSpaceOnUse">
...
export function MirrorballGlass() {
  return (
    <svg viewBox="0 0 300 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-full w-full" aria-hidden="true">
      <path d="M100 100 L200 100 L150 300 L140 300 L150 320 L160 320 L150 300 Z" stroke="#E2E8F0" strokeWidth="4" />
      <path d="M101 101 L199 101 L152 290 L148 290 Z" fill="url(#mirrorballGrad)" opacity="0.92" />
      <g opacity="0.85">
      ...
      <defs>
        <linearGradient id="mirrorballGrad" x1="150" y1="100" x2="150" y2="290" gradientUnits="userSpaceOnUse">
...
export function MocktailIllustration({ name }: { name: keyof typeof illustrations }) {
